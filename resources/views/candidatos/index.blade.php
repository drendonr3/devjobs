...
@section('content')
    <h1 class="text-2xl text-center mt-10">Candidatos: <span class="text-normal">{{$vacante->titulo}}</span></h1>
        ...
        <ul class="max-w-md mx-auto mt-10">
            @foreach ($vacante->candidatos as $candidato)
                <li class="p-5 border border-gray-400 mb-5">
                    ...
                    <a href="/storage/cv/{{$candidato->cv}}" class="bg-gray-500 p-3 inline-block text-xs font-bold uppercase text-white">Ver CV</a>
                </li>
            @endforeach
        </ul>
    @else
